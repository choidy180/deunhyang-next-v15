    ...
    return (
        <Wrapper>
            ...
            <Form>
                ...
                <SubmitButton error={error} type="button" onClick={handleSubmit}>회원가입하기</SubmitButton>
            </Form>
        </Wrapper>
    );
};
...
const SubmitButton = styled.button<{ error: string }>`
    width: 100%;
    padding: 14px 0;
    ...
    margin-top: ${({ error }) => (error ? '.2rem' : '2rem')};
